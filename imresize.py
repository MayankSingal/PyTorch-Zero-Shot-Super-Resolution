...
if __name__ == '__main__':
	input_img = img.imread('images/lincoln.png')
	#print(input_img)
	print(type(input_img))
	
	print(input_img.shape)
	test = father_to_son(input_img) #imresize()
	print(test.shape)
	test_resize = imresize(test, 2, input_img.shape, "cubic")
	print(type(test_resize))
